...
for column in all_years_data.columns:
    print(column)
...
filtered_data = all_years_data[list(columns_to_keep.keys())]
...
filtered_data.to_csv("filtered_stats_2045_2063.csv", index=False)
print("Filtered data saved to filtered_stats_2045_2063.csv")
